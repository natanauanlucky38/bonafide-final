...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 01, 2024 at 07:42 PM
...
(1, 'Software Engineer', 'Tech Innovators', 'New York', 70000.00, 100000.00, 'Develop and maintain software applications.', 3, 7, '2024-12-01', 'ACTIVE', NULL, '2024-10-15 10:30:00', 1),
(2, 'Data Scientist', 'Data Corp', 'San Francisco', 80000.00, 120000.00, 'Analyze data and develop predictive models.', 5, 7, '2024-12-05', 'ACTIVE', NULL, '2024-10-17 11:45:00', 1),
(3, 'UX Designer', 'Creative Studio', 'Los Angeles', 60000.00, 85000.00, 'Design user-friendly interfaces.', 2, 7, '2024-12-10', 'ACTIVE', NULL, '2024-10-18 09:20:00', 1),
(4, 'Project Manager', 'BuildWorks', 'Seattle', 90000.00, 110000.00, 'Manage software development projects.', 1, 7, '2024-12-15', 'ACTIVE', NULL, '2024-10-22 08:50:00', 1),
(5, 'QA Engineer', 'Tech Innovators', 'New York', 50000.00, 70000.00, 'Ensure software quality.', 4, 7, '2024-12-20', 'ACTIVE', NULL, '2024-10-23 13:15:00', 1),
(6, 'Network Engineer', 'NetSecure', 'Chicago', 65000.00, 95000.00, 'Maintain network security.', 2, 7, '2024-12-25', 'ACTIVE', NULL, '2024-10-24 16:30:00', 1),
(7, 'Digital Marketer', 'MarketMax', 'Austin', 55000.00, 75000.00, 'Create and manage marketing campaigns.', 3, 7, '2024-12-30', 'ACTIVE', NULL, '2024-10-26 15:00:00', 1),
(8, 'Data Engineer', 'Data Corp', 'San Francisco', 75000.00, 105000.00, 'Build data infrastructure.', 5, 7, '2025-01-05', 'ACTIVE', NULL, '2024-10-27 17:25:00', 1),
(9, 'Sales Manager', 'BizGroup', 'Houston', 60000.00, 80000.00, 'Lead sales team to achieve targets.', 4, 7, '2025-01-10', 'ACTIVE', NULL, '2024-10-29 14:45:00', 1),
(10, 'IT Support Specialist', 'Tech Solutions', 'Boston', 45000.00, 60000.00, 'Provide technical support to clients.', 6, 7, '2025-01-15', 'ACTIVE', NULL, '2024-10-30 12:00:00', 1);
...
(1, 1, 20, 200, 180, 150, 100, 80, 50, 30, 70, 100, 20),
(2, 2, 30, 250, 220, 180, 120, 90, 60, 40, 80, 130, 30),
(3, 3, 15, 150, 130, 110, 90, 60, 40, 20, 50, 80, 10),
(4, 4, 25, 300, 270, 240, 150, 110, 80, 60, 100, 140, 40),
(5, 5, 10, 100, 90, 70, 50, 30, 20, 10, 30, 50, 5),
(6, 6, 18, 220, 200, 170, 140, 100, 70, 50, 90, 80, 20),
(7, 7, 12, 120, 110, 95, 70, 50, 30, 20, 40, 60, 10),
(8, 8, 22, 270, 250, 210, 160, 120, 90, 70, 110, 100, 25),
(9, 9, 8, 80, 70, 55, 45, 35, 20, 15, 25, 40, 5),
(10, 10, 14, 140, 130, 100, 80, 60, 40, 30, 50, 60, 15);
