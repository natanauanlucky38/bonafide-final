            ...
            <?php while ($application = $applications_result->fetch_assoc()): ?>
                <tr>
                    ...
                    <td>
                        ...
                        <?php if (!empty($application['uploaded_file_url'])): ?>
                            <?php
                            // Construct the full URL to access the uploaded file
                            $uploaded_file_url = 'applicants/uploads/' . htmlspecialchars($application['uploaded_file_url']);
                            ?>
                            <a href="<?php echo $uploaded_file_url; ?>" target="_blank">View File</a>
                        <?php else: ?>
                            No file uploaded.
                        <?php endif; ?>
                    </td>
